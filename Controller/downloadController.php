...
class downloadController
{
    ...
    public function renderModifyPicture($id, $sepia, $blurRadius, $blurSigma, $width, $height, $original)
    {
        //$html  = $this->header->renderTemplate();
        //$html .= $this->footer->renderTemplate();
        $this->dowSys->download($id, $sepia, $blurRadius, $blurSigma, $width, $height, $original);
        return $html;
    ...
    private function renderBodyModify($id)
    {
        ...
        <form action="download.php" method="post" >
            ...
            Blur sigma <input type="range" name="blurSigma" min="0" max="100"/>
